-- Active: 1706776144383@@127.0.0.1@3306@estate
# Entity
# - 사용자
# - 이메일 인증번호
# - 게시물
...
# - 이메일 인증번호(이메일, 인증번호)
# - 게시물(접수번호, 상태, 제목, 작성자, 작성일, 조회수, 내용, 답글)
...
# user_email : VARCHAR(100) NN UQ FK(email)
...
# contents : TEXT NN
# writer_id : VARCHAR(50) NN FK(user_id)
