...
INSERT INTO player VALUES ('쿠보 타케후사', 0, null, null, null, '일본');
...
-- 플레이어 이름이 쿠보 다케후사이면서 국적이 일본이면 나이를 24, 포지션을 MF/FW, 프로팀을 레알 소시에다드, 등번호를 20로 변경
...
UPDATE player SET age = 24, position = 'MF/FW', pro_team = '레알 소시에다드', uniform_number = 20 WHERE name = '쿠보 타케후사' AND country = '일본';
