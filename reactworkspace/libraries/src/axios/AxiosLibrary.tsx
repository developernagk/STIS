...
export default function AxiosLibrary() {
  ...
  axios
    ...
    .catch(error => {
      // 해당 request에 대해서 request가 실패하거나 status code가 400, 500번대이면 AxiosError 객체를 받아옴
    ...
    axios.get(GET_URL, { headers: { 'Authorization' : 'Bearer 789465' }, params: { 'time': '1144' } });

    // request body 매개변수
    // - post, patch, put 함수는 두번째 매개변수로 request body 데이터르 전달함
