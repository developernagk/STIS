...
public class A_Variable {
	...
	public static void main(String[] args) {
		...
		// 3. 연산자로 사용되는 특수문자를 포함할 수 없음(공백 사용할 수 없음)
		// int age+;
		int age$_; // $만 있는 것은 이름을 정하지 못한 것(미정)
