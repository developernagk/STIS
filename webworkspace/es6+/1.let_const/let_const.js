...
console.log(funcLevel); // 출력: 10

// 블럭 레벨 변수는 해당 블럭 외부에서 사용 불가능
// {
//     let blockLevel = 10;
// }
// console.log(blockLevel); 출력: (에러 발생 ReferenceError: blockLevel is not defined)
...
*/
console.log(varHoisting); // 출력: undefined
var varHoisting = 10;

// console.log(letHoisting); 출력: (에러 발생 ReferenceError: Cannot access 'letHoisting' before initialization)
// let letHoisting = 10;
...
// const INITIALIZATION; 컴파일 에러는 아니지만 초기화가 이루어지지 않아서 문법 에러가 발생
