...
// console.log('A point'); // 출력: A point
// console.log(promise); // 출력: Promise { <rejected> 'Fail' }
// console.log('B point'); // 출력: B point
// promise
//     .then((result) => {console.log(result)})
//     .catch((result) => {console.log(`catch : ${result}`)}); // 출력: catch : Fail(출력 순서는 가장 마지막)
// console.log('C point'); // 출력: C point
