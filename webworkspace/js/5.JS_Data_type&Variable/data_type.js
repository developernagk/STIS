...
*/
// console.log(integer === double); 출력: true
...
*/
var plus_inf = 1 / 0;
// console.log(plus_inf); 출력: Infinity
var minus_inf = -1 / 0;
// console.log(minus_inf); 출력: -Infinity
var nan = 1 * 'string';
...
//  console.log(name_[index]); 출력: 홍 / 길 / 동
}
...
if (name_) {
//  console.log('name은 빈 문자열이 아닙니다.') 출력: (아무것도 출력되지 않음)
}
...
/*
    ...
    - 함수에 반환값으로 유효한 값이 없을 때 반환하는 용도
    - null 값은 typeof 타입확인 연산자로 확인하면 object 타입이 반환됨(단순 javascript 자체의 문제)
*/
obj = null;

// html에서 아래의 코드를 적으면 실행됨 javascript 내에서는 에러 발생
